...
type Service struct {
	bodyTemplatesMap *xsync.Map[contract.TemplateName, *template.Template]
	subjectsMap      *xsync.Map[contract.TemplateName, string]
}
...
func (s *Service) RenderTemplate(name contract.TemplateName, payload any) (*RenderedTemplate, error) {
...
func (s *Service) renderTemplateBody(name contract.TemplateName, payload any) (*bytes.Buffer, error) {
